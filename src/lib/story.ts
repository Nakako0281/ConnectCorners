        ...
        pages: [
            {
                ...
                content: [
                    ...
                    { type: 'dialogue', speaker: 'リズ', icon: 'Riz.png', text: '「そこ、角を取れば理論上は勝率85%アップよ」' },
                    { type: 'text', text: 'と眼鏡を光らせるリズ。' },
                    { type: 'dialogue', speaker: 'ロッカ', icon: 'Rocca.png', text: '「細かい確率はいいの！ ドーンと攻めれば道は開ける！」' },
                    { type: 'text', text: 'と強引にピースをねじ込むロッカ。' },
                    { type: 'dialogue', speaker: 'マロ', icon: 'Mallo.png', text: '「あ、お花にお水あげなきゃ……でも、ここは通さないよ？」' },
                    { type: 'text', text: 'とニコニコしながら鉄壁の守りを築くマロ。' },
                    { type: 'text', text: 'そして、' },
                    { type: 'dialogue', speaker: 'ピコ', icon: 'Pico.png', text: '「へへっ、ここを繋げたら盤面がピカピカ光る改造しちゃった！」' },
            ...
            },
            {
                ...
                content: [
                    ...
                    { type: 'dialogue', speaker: 'ミズキ', icon: 'Mizuki.png', text: '「ごきげんよう。ここが噂の戦略ゲーム部ですか？」' },
                    { type: 'text', text: '冷静な眼差しで部室を見渡すミズキ。' },
                    { type: 'dialogue', speaker: 'アムール', icon: 'Amour.png', text: '「あら、部室のレイアウトに美学を感じないわね……愛が足りないわ」' },
                    { type: 'text', text: 'と嘆くアムール。' },
                    { type: 'dialogue', speaker: 'ソレイユ', icon: 'Soleil.png', text: '「堅いこと言わないでさ！ 一緒に遊ぼうよ～！」' },
            ...
            },
            {
                ...
                content: [
                    ...
                    { type: 'dialogue', speaker: 'ロッカ', icon: 'Rocca.png', text: '「激辛の後のプリン……最高じゃない！」' },
                    { type: 'dialogue', speaker: 'リズ', icon: 'Riz.png', text: '「甘味による脳の活性化は、次の研究に必要不可欠ね」' },
                    { type: 'text', text: 'とリズが計算を始める。' },
                    { type: 'dialogue', speaker: 'マロ', icon: 'Mallo.png', text: '「えへへ、食べてみたいな」' },
                    { type: 'text', text: 'とマロも珍しく乗り気。' },
                    { type: 'dialogue', speaker: 'ピコ', icon: 'Pico.png', text: '「プリンの揺れ方を解析したい！」' },
                    { type: 'text', text: 'とピコも興奮。\n\nしかし、それはセレスティア女学院のメンバーも同じだった。' },
                    { type: 'dialogue', speaker: 'ミズキ', icon: 'Mizuki.png', text: '「データによれば、そのプリンの糖度は至高。譲るわけにはいかないわ」' },
                    { type: 'dialogue', speaker: 'アムール', icon: 'Amour.png', text: '「美しきプリンこそ、愛の城の住人にふさわしい！」' },
                    { type: 'dialogue', speaker: 'ソレイユ', icon: 'Soleil.png', text: '「食べたーい！ 勝った方がもらえるんだよね？ 燃えてきた！」' },
                    { type: 'dialogue', speaker: 'ノワール', icon: 'Noir.png', text: '「……（コクリ）」' },
        ...
        pages: [
            {
                ...
                content: [
                    ...
                    { type: 'dialogue', speaker: 'ミズキ', icon: 'Mizuki.png', text: '「悔しいけど、あの最後の一手、計算外だったわ」' },
                    { type: 'text', text: 'とミズキが眼鏡の位置を直せば、' },
                    { type: 'dialogue', speaker: 'リズ', icon: 'Riz.png', text: '「そっちこそ、私の直感を封じ込めるなんてやるじゃない」' },
                    { type: 'text', text: 'とリズが不敵に笑う。\nロッカとアムールは' },
                    { type: 'dialogue', speaker: 'ロッカ', icon: 'Rocca.png', text: '「熱い魂を感じた！」' },
                    { type: 'dialogue', speaker: 'アムール', icon: 'Amour.png', text: '「美しい情熱的な愛だったわ！」' },
                    ...
                    { type: 'dialogue', speaker: 'ソレイユ', icon: 'Soleil.png', text: '「これからも合同練習しようよ！」' },
                    { type: 'dialogue', speaker: 'リズ', icon: 'Riz.png', text: '「ええ、望むところよ」' },
            ...
            },
            {
                title: "黄金の輝き、部室を制圧！？",
                content: [
                    { type: 'dialogue', speaker: '？？？', icon: 'Aura.png', text: '「おーっほっほっほ！ おーっほっほっほ！！」' },
                    { type: 'text', text: '部室の空気を切り裂くような高笑いとともに、窓ガラスがガタガタと震えた。まばゆい黄金の光が差し込み、\nそこに立っていたのは、目がくらむほど豪華絢爛なドレスとマントを身にまとった、優雅に扇子を仰ぐ少女だった。' },
                    { type: 'dialogue', speaker: 'オーラ', icon: 'Aura.png', text: '「むさ苦しい部室ですわね。ここを私の『別荘兼・戦略ゲーム保管庫』に改装しますわ」' },
                    { type: 'text', text: '彼女の名はオーラ。宇宙全土にチェーン展開する超巨大財閥の令嬢だ。' },
                    { type: 'dialogue', speaker: 'ロッカ', icon: 'Rocca.png', text: '「な、なによあんた！ いきなり入ってきて！」' },
                    { type: 'text', text: 'とロッカが吠えるが、オーラは全く動じない。' },
                    { type: 'dialogue', speaker: 'オーラ', icon: 'Aura.png', text: '「あら、自己紹介が遅れましたわね。わたくしたちは、この銀河の戦略ゲーム界を統べる（予定の）BIG3。あなたたちのようなアマチュアとは、格が違いましてよ？」' },
            ...
            },
            {
                title: "過去と未来",
                content: [
                    { type: 'dialogue', speaker: 'テラ', icon: 'Terra.png', text: '「……やれやれ。これだから最近の若者は。礼儀も作法もなっていない」' },
                    { type: 'text', text: '重厚な金属音を響かせて進み出てきたのは、くすんだ赤銅色の古代アーマーを身につけたテラだった。' },
                    { type: 'dialogue', speaker: 'テラ', icon: 'Terra.png', text: '「我が一族に伝わる古のレリック（遺物）に比べれば、貴様らの使う最新式ボードなど、ただのおもちゃに過ぎん」' },
                    { type: 'text', text: '彼女が持つピースは、見たこともない古代金属でできており、鈍く、しかし重厚な威圧感を放っている。\n\nその頭上、天井付近をふわふわと浮遊している少女がいた。' },
                    { type: 'dialogue', speaker: 'ルナ', icon: 'Luna.png', text: '「……んぅ……あ、終わった？」' },
                    { type: 'text', text: 'ルナは大きな星型の抱き枕にしがみつき、ウサギ耳のパーカーを深く被ったまま眠たげに呟く。' },
                    { type: 'dialogue', speaker: 'ルナ', icon: 'Luna.png', text: '「……戦う前から、結果見えちゃった。……私達の勝ち。おやすみ……」' },
            ...
            },
            {
                title: "立ち上がれ、8人の絆！",
                content: [
                    { type: 'dialogue', speaker: 'ルナ', icon: 'Luna.png', text: '「この部室は、私の昼寝に最適なの……だから、もらうね」' },
                    { type: 'text', text: 'とルナが寝言のように言う。' },
                    { type: 'dialogue', speaker: 'テラ', icon: 'Terra.png', text: '「古代遺跡の静寂を守るため、この騒がしい場所は封印させてもらう」' },
                    { type: 'text', text: 'とテラが淡々と告げる。' },
                    { type: 'dialogue', speaker: 'オーラ', icon: 'Aura.png', text: '「そして何より！ この私が勝利の輝きで満たすためにね！ さあ、かかってらっしゃい！」' },
                    ...
                    { type: 'dialogue', speaker: 'リズ', icon: 'Riz.png', text: '「……確率は未知数。でも、今の私達なら計算式を超えられるわ」' },
                    { type: 'text', text: 'リズが眼鏡を押し上げる。' },
                    { type: 'dialogue', speaker: 'ミズキ', icon: 'Mizuki.png', text: '「ええ。過去のデータも、未来の予知も、今の私たちの『結束』には勝てないわよ」' },
